...
function Menu() {
  ...
  useEffect(() => {
    const loadCategories = async () => {
      ...
      // Separate Miscellaneous and sort other categories alphabetically
      ...
      // Combine with Miscellaneous last
  ...
  // Calculate and set minimum content height
  useEffect(() => {
    if (contentRef.current) {
      ...
      if (cards.length > 0) {
        ...
        const rows = Math.ceil(cards.length / 4); // Assuming 4 columns max
